...
def create_tf_example(image,
  ...
  feature_dict = {
      'image/height':
          _int64_feature(image_height),
      'image/width':
          _int64_feature(image_width),
      'image/filename':
          _bytes_feature(filename.encode('utf8')),
      'image/source_id':
          _bytes_feature(str(image_id).encode('utf8')),
      'image/key/sha256':
      ...
      'image/object/bbox/xmin':
          _float_list_feature(xmin),
      'image/object/bbox/xmax':
          _float_list_feature(xmax),
      'image/object/bbox/ymin':
          _float_list_feature(ymin),
      'image/object/bbox/ymax':
          _float_list_feature(ymax),
      'image/object/class/text':
          _bytes_list_feature(category_names),
      'image/object/is_crowd':
          _int64_list_feature(is_crowd),
      'image/object/area':
          _float_list_feature(area),
  }
  if include_masks:
    feature_dict['image/object/mask'] = (
        _bytes_list_feature(encoded_mask_png))
  if include_keypoint:
    feature_dict['image/object/keypoint/x'] = (
        _float_list_feature(keypoints_x))
    feature_dict['image/object/keypoint/y'] = (
        _float_list_feature(keypoints_y))
    feature_dict['image/object/keypoint/num'] = (
        _int64_list_feature(num_keypoints))
    feature_dict['image/object/keypoint/visibility'] = (
        _int64_list_feature(keypoints_visibility))
    feature_dict['image/object/keypoint/text'] = (
        _bytes_list_feature(keypoints_name))
